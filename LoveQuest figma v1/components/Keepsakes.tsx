...
export default function Keepsakes() {
  ...
  return (
    <div className="min-h-screen pt-8 pb-24 px-4 relative overflow-hidden">
      ...
      <motion.div
        className="absolute top-32 left-12 text-2xl opacity-40 animate-float-delayed"
        initial={{ opacity: 0 }}
        animate={{ opacity: 0.4 }}
      ...
      >
        ...
        {/* Progress and stats */}
        <motion.div
          className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 max-w-2xl mx-auto shadow-lg border border-rose-gold/20 mb-8"
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
        ...
        >
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-center">
            <div>
              <div className="font-playfair text-2xl text-blush-pink">{unlockedCount}/{totalCount}</div>
              <div className="font-caveat text-sm text-peach-puff">Unlocked</div>
            </div>
            <div>
          ...
          <div className="mt-4">
            <div className="flex items-center justify-between mb-2">
              <span className="font-caveat text-sm text-blush-pink">Collection Progress</span>
              <span className="font-inter text-xs text-gray-600">
                {Math.round((unlockedCount / totalCount) * 100)}%
              </span>
            </div>
            <div className="bg-ivory-paper rounded-full h-3 overflow-hidden">
              <motion.div
